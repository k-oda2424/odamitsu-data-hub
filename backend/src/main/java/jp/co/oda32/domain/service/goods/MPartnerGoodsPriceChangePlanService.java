...
public class MPartnerGoodsPriceChangePlanService extends CustomService {
    ...
    /**
     * 自動生成され「作成」ステータスの見積に対応する得意先価格変更予定の見積作成フラグをリセットします。
     *
     * @return リセット件数
     */
    @org.springframework.transaction.annotation.Transactional
    public int resetEstimateCreatedForAutoGeneratedCreateEstimate() {
        return this.mPartnerGoodsPriceChangePlanRepository.resetEstimateCreatedForAutoGeneratedCreateEstimate();
    }
