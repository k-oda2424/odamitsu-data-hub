...
@ShopEntity
public class MPurchasePrice implements IEntity {
    @Id
    @Column(name = "purchase_price_no")
    @SequenceGenerator(name = "m_purchase_price_purchase_price_no_seq_gen", sequenceName = "m_purchase_price_purchase_price_no_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "m_purchase_price_purchase_price_no_seq_gen")
    ...
    private WSalesGoods wSalesGoods;
}
